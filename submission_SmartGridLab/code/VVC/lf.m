...
% Paramètres d'entrées : matrices de description du réseau

% Matrice Line
% Modèle en Pi de la ligne :
%            d        R       X=lw      a
%       -------------[]------mmm-------------
%            |                          |
%          -----                      -----  Cw/2
...
% - Colonne 1 : Noeud de départ
% - Colonne 2 : Noeud d'arrivée
% - Colonne 3 : R (pu)
% - Colonne 4 : X(pu)
% - Colonne 5 : Cw/2 (pu)
...
% Matrice Bus
%   - Colonne 1 : Numéro du noeud
%   - Colonne 2 : Tension initiale en chaque noeud
%   - Colonne 3 : Déphasage de la tension par rapport au noeud de référence
%   (noeud bilan)initial
%   - Colonne 4 : Puissance active générée (en pu)
%   - Colonne 5 : Puissance réactive générée (en pu)
%   - Colonne 6 : Puissance active consommée (en pu)
%   - Colonne 7 : Puissance réactive consommée (en pu)
%   - Colonne 8 : inutilisée ici (zeros)
%   - Colonne 9 : inutilisée ici (zeros)
%   - Colonne 10 : Type de noeud



% Paramètres de sorties
% - bus_sol : matrice bus solution avec : 
%   - Colonne 1 : Numéro du noeud
%   - Colonne 2 : Tension finale au noeud calculée par le loadflow
%   - Colonne 3 : Déphasage de la tension par rapport au noeud de référence
...
%   - Colonne 9 : inutilisée ici (zeros)
%   - Colonne 10 : Type de noeud
%   - Colonne 10 : inutilisée ici 
%   - Colonne 11 : inutilisée ici
%   - Colonne 12 : inutilisée ici (vecteur unitaire)
%   - Colonne 13 : Vmax 
%   - Colonne 14 : Vmin 

% - P_loss : pertes actives en pu

% - I_lignes_pu : Courant dans les lignes en pu

% - iter = nombre d'itération pour le loadflow
